...
public class orderAdapter extends BaseAdapter implements ListAdapter {
    ...
    public orderAdapter(ArrayList<String> listNumber, ArrayList<String> list, ArrayList<String> listQty, ArrayList<String> listNum, ArrayList<String> listPtice, Context context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbHelper.deleteOrder(listNumber.get(position));
